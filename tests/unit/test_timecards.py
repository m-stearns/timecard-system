...
week_ending_date = common.create_date_from_iso("2022-08-12")
...
def test_validate_number_of_days_entered_invalid():
    ...
    dates_and_hours[common.create_date_from_iso("2022-08-13")] = \
        model.WorkDayHours(Decimal("8.0"), Decimal("0.0"), Decimal("0.0"))
    dates_and_hours[common.create_date_from_iso("2022-08-14")] = \
        model.WorkDayHours(Decimal("8.0"), Decimal("0.0"), Decimal("0.0"))
    dates_and_hours[common.create_date_from_iso("2022-08-15")] = \
        model.WorkDayHours(Decimal("8.0"), Decimal("0.0"), Decimal("0.0"))
